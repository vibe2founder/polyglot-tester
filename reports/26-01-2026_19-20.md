...
## O que foi feito
1. **Renaming de Marca**: O projeto foi renomeado de `@purecore/one-proof-4-all` para `@purecore/one-proof-4-all` em todos os arquivos de configura├º├úo (`package.json`, `tsconfig.json`).
